...
public class DeletePlayerCommand extends Command {
    ...
    DeletePlayerCommand(Controller controller) {
        super("player-remove", 1, "[player] Elimina del sistema a un jugador, siempre que no participe en un torneo en curso ni pertenezca a un equipo que esté participando en uno.");
